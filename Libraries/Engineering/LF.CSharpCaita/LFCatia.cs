...
namespace LF.CSharpCatia
{
    ...
    public class LFCatia
    {
        ...
        public Reference DrawLoft(Reference[] s, Reference g1, Reference[] g2)
        {
            int ns = s.Length;
            int ng2 = g2.Length;
            HybridShapeLoft shape = Shapes.AddNewLoft();
            ...
            shape.AddGuide(g1);
            Shapes.GSMVisibility(g1, 0);

            for (int i = 0; i < ng2; i++)
            {
                shape.AddGuide(g2[i]);
                Shapes.GSMVisibility(g2[i], 0);
            }
        ...
        public Reference DrawLoft(Reference[] s, Reference g1, Reference[] g2, Reference[] g3)
        {
            int ns = s.Length;
            int ng2 = g2.Length;
            int ng3 = g3.Length;
